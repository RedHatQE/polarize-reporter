...
public enum ReporterConfigOpts implements IGetOpts {
    ...
    TR_INCLUDE_SKIPPED("include-skipped", "When making an XUnit Import request, if set to true, also include any " +
            ...
            "Relevant to xunit"),
    EDIT_CONFIG("edit-config", "When set to true, only sets values to the polarize-config file (given as the first " +
    ...
    CONFIG("config", "Path of the polarize-config file to use"),
